...
//, double (*Viscosity)(),double (*Rho)() , double (*U_ref)(), double (*L_ref)())	
{
	...
	double y23, y31, y12, x32, x13, x21, X[3], Y[3], Ke[9][9], Fe[9], ux1, ux2, ux3, uy1, uy2, uy3, ux, uy, duxdx, duxdy, duydx, duydy, x, y;
