...
int Build_VMS(ParametersType *Parameters, MatrixDataType *MatrixData, FemStructsType *FemStructs, FemFunctionsType *FemFunctions)
{
	int e, i;
	int nel, neq;
	...
	for(e = 0; e < nel; e++){
		...
		// Abb = Dbb + Rbb (Cbb = 0)
		double Abb = ConstDbb*(D1 + D2 + D3) + ConstRbb;
