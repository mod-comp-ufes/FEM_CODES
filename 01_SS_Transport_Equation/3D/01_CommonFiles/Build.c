...
int Build(ParametersType *Parameters, MatrixDataType *MatrixData, FemStructsType *FemStructs, FemFunctionsType *FemFunctions)
{
	int e, i;
	int nel, neq;
	...
	dzero(neq+1, F); // zerando termo fonte

	setZeros(Parameters,MatrixData); // zerando matriz dos elementos
	...
	for(e = 0; e < nel; e++){
		...
		// Elementary Matrix
		Ke[0][0] = ConstD*E11 + ConstC*C1 + 2*ConstR; 
		Ke[1][0] = ConstD*E12 + ConstC*C1 + ConstR; 
		Ke[2][0] = ConstD*E13 + ConstC*C1 + ConstR; 
		Ke[3][0] = ConstD*E14 + ConstC*C1 + ConstR; 
		
		Ke[0][1] = ConstD*E12 + ConstC*C2 + ConstR; 
		Ke[1][1] = ConstD*E22 + ConstC*C2 + 2*ConstR;            
		Ke[2][1] = ConstD*E23 + ConstC*C2 + ConstR;            
		Ke[3][1] = ConstD*E24 + ConstC*C2 + ConstR;            
		
		Ke[0][2] = ConstD*E13 + ConstC*C3 + ConstR; 
		Ke[1][2] = ConstD*E23 + ConstC*C3 + ConstR;              
		Ke[2][2] = ConstD*E33 + ConstC*C3 + 2*ConstR;              
		Ke[3][2] = ConstD*E34 + ConstC*C3 + ConstR;              
		            
		Ke[0][3] = ConstD*E14 + ConstC*C4 + ConstR;            
		Ke[1][3] = ConstD*E24 + ConstC*C4 + ConstR;            
		Ke[2][3] = ConstD*E34 + ConstC*C4 + ConstR;            
		Ke[3][3] = ConstD*E44 + ConstC*C4 + 2*ConstR;            
		...
		Fe[0]  = ConstF*(Faux + f[0]);
		Fe[1]  = ConstF*(Faux + f[1]);
		Fe[2]  = ConstF*(Faux + f[2]);
		Fe[3]  = ConstF*(Faux + f[3]);			
