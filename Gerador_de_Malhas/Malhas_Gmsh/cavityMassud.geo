cl = 0.5;
nsp = 141;  //numero de sub particoes
...
razao = 0.3;                              // malha: 61=>0.05, 121=> 0.1 241=> 0.2
Transfinite Line{1} = nsp Using Bump razao;  
Transfinite Line{2} = nsp Using Bump razao;
Transfinite Line{3} = nsp Using Bump razao;
Transfinite Line{4} = nsp Using Bump razao;
