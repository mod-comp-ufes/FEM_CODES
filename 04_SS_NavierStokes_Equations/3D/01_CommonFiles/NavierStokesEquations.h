...
typedef struct
{
	...
	int v1Type, v2Type, v3Type, pType; // mark of the node according to boundary conditions
...
typedef struct
{
	...
	double (*f3ext)(double, double, double);
...
int Build_K_F_MS(ParametersType *, MatrixDataType *, FemStructsType *, FemFunctionsType *);
