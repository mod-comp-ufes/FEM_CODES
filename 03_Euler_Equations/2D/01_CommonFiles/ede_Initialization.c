...
void ede_Initialization(ParametersType *Parameters, NodeType *Node, ElementType *Element, int **order, int ***lm_out, int **lmaux_out, int ***EDGE_by_Element_out)
{
	int nnodes, neq, nel;
	...
	EDGE_List = (NodeListType **)mycalloc("EDGE_List of 'EDE_Initialization'",nnodes,sizeof(NodeListType *));
	...
	EDGE_by_Element = (int**) mycalloc("EDGE_by_Element of 'ede_Initialization'",nel,sizeof(int*));
	for (K = 0; K < nel; K++)
		EDGE_by_Element[K] = (int*) mycalloc("EDGE_by_Element of 'ede_Initialization'", NNOEL,sizeof(int));
	...
	lm = (int**) mycalloc("lm of 'ede_Initialization'",nedge, sizeof(int*));
	lmaux = (int*) mycalloc("lmaux of 'ede_Initialization'",2*NDOF*nedge, sizeof(int));
